...
from dataset.tum_mls_dataset import all_file_prefixes

def down_sample(
    dense_pcd_path, dense_label_path, sparse_pcd_path, sparse_label_path, voxel_size
):
    print("dense_label_path",dense_label_path)
    print(os.path.isfile(dense_label_path))
    # Skip if done
    ...
    sparse_pcd, cubics_ids = dense_pcd.voxel_down_sample_and_trace(
...
if __name__ == "__main__":
    ...
    current_dir = "/home/ge75jek/data/TUM-MLS/small/"
    dataset_dir = current_dir
    raw_dir = os.path.join(dataset_dir, "semantic_raw")
    downsampled_dir = os.path.join(dataset_dir, "pointnet2_semantic_downsampled")
